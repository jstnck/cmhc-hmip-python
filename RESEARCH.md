...
Scope: figure out what CMHC data exists, how to get it programmatically, and where the landmines are. This is reconnaissance — see `PLAN.md` for design and `PROGRESS.md` for current state.
